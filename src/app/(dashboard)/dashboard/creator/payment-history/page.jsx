    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className={`text-sm text-gray-500 mt-1 ${inter.className}`}>All your approved withdrawal payouts.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
                {loading ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className={`text-sm text-gray-500 ${inter.className}`}>No payout history yet.</p>
                    </div>
                ) : (
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className={`text-xs text-gray-500 uppercase tracking-wider ${inter.className}`}>
                                    <th className="text-left px-6 py-3 font-medium">Credits Withdrawn</th>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {payments.map((p) => (
                                    <tr key={p._id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className={`px-6 py-4 text-sm text-gray-700 capitalize ${inter.className}`}>{p.paymentMethod}</td>
